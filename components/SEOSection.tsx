...
export default function SEOSection({ zoneA, zoneB }: SEOSectionProps) {
  const isPairing = zoneA && zoneB;

  // Generate FAQ Schema dynamically based on whether it is a pairing page or the homepage
  const getFaqSchema = () => {
    if (isPairing) {
      ...
      return {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": `How do I convert ${nameA} to ${nameB}?`,
            "acceptedAnswer": {
              "@type": "Answer",
              "text": `To convert ${nameA} to ${nameB}, add ${cityA} and ${cityB} to the MeetMyZone timeline planner. The tool aligns their daily clocks side-by-side on a horizontal grid, letting you translate local times instantly.`
            }
          },
          {
            "@type": "Question",
            "name": `What is the best time to meet between ${cityA} and ${cityB}?`,
            "acceptedAnswer": {
              "@type": "Answer",
              "text": `The best time to meet across ${nameA} and ${nameB} time zones is when standard working hours overlap. MeetMyZone acts as a working hours overlap calculator, highlighting optimal meeting brackets where both regions share standard business hours.`
            }
          },
          {
            "@type": "Question",
            "name": `How do I schedule an international meeting between ${cityA} and ${cityB}?`,
            "acceptedAnswer": {
              "@type": "Answer",
  ...
  return (
    <section id="how-it-works" className="w-full bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-900 py-12 sm:py-16 transition-colors duration-250">
      <script
        ...
        {isPairing ? (
          ...
          <div className="flex flex-col gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col gap-3">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white leading-tight tracking-tight">
                {zoneA.displayName} to {zoneB.displayName} Time Zone Converter & Meeting Planner
              </h1>
              <p className="text-xs sm:text-sm text-blue-500 dark:text-blue-400 font-medium font-mono uppercase tracking-wider">
                Comparing Timezones: {zoneA.cityName} ({zoneA.zoneName}) & {zoneB.cityName} ({zoneB.zoneName})
              </p>
            </div>
            
            <div className="flex flex-col gap-6 text-xs sm:text-sm leading-relaxed text-slate-650 dark:text-slate-400">
              <p>
                Welcome to the ultimate <strong>{zoneA.displayName} to {zoneB.displayName}</strong> time converter. When coordinating workflows between remote offices, freelancers, and clients across the world, managing calculations for <strong>time zones</strong> manually is slow and prone to errors. Whether you are translating <strong>est to ist</strong>, <strong>pst to est</strong>, <strong>utc to ist</strong>, <strong>gmt to est</strong>, or <strong>cet to est</strong>, this page helps you identify standard working hours side-by-side on an interactive, visual grid.
              </p>
              
              <h2 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-slate-200 mt-2">
                Find the Best Time to Meet Across {zoneA.displayName} and {zoneB.displayName}
              </h2>
              <p>
                To schedule a meeting across these zones, you need to calculate their working hours overlap. MeetMyZone serves as an intuitive <strong>time zone overlap calculator</strong> and <strong>working hours overlap calculator</strong>. For example, if you are looking for the <strong>best time for us and india meeting</strong>, or coordinating time offsets like <strong>singapore to est</strong> and <strong>london to new york time</strong>, the grid above maps daily schedules column-by-column. The highlighted green blocks represent the standard working hour overlap, showing you precisely when both participants are active.
              </p>
              
              <h3 className="text-base sm:text-lg font-bold text-slate-800 dark:text-slate-200 mt-2">
                How to Coordinate Meetings and Shares
              </h3>
              <p>
                If you are planning an international sync, this <strong>time zone meeting planner</strong> makes scheduling simple:
              </p>
              <ul className="list-disc list-inside ml-2 flex flex-col gap-2">
                <li><strong>Confirm Time Offsets</strong>: The vertical slider aligns hours using standard timezone calculations. It automatically processes daylight saving updates, serving as a reliable <strong>daylight saving time converter for meetings</strong>.</li>
                <li><strong>Select Your Slot</strong>: Click on the hour block that works best for all stakeholders.</li>
                <li><strong>Copy Summary & Export</strong>: Copy the preformatted meeting invite summary containing local times for Slack/Email, or directly click the export button to generate calendar events in Google Calendar.</li>
              </ul>
              <p>
                Our <strong>world clock meeting planner</strong> handles calculations entirely in the browser sandbox. This ensures absolute data privacy—your coordinates and locations are never saved on a server. Use this <strong>remote team time zone tool</strong> to establish healthy boundaries, prevent burnout, and coordinate global projects seamlessly.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <span className="p-1.5 rounded-lg bg-teal-555/10 text-teal-600 dark:text-teal-400">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-10 max-w-4xl mx-auto w-full flex flex-col gap-6 text-xs sm:text-sm leading-relaxed text-slate-650 dark:text-slate-400">
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-10 max-w-4xl mx-auto w-full">
              ...
              <div className="flex flex-col border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-slate-900 overflow-hidden divide-y divide-slate-200 dark:divide-slate-800 shadow-sm">
                ...
                <details className="group p-4 sm:p-5 cursor-pointer">
                  ...
                  <p className="mt-3 text-xs sm:text-sm text-slate-550 dark:text-slate-400 leading-relaxed font-sans">
